...
const Authorcollection= require("../controllers/AuthorCollection")
...
router.post("/createAuthor",Authorcollection.createAuthor )

router.get("/getbooksdata", Bookcollection.getbooksdata)
